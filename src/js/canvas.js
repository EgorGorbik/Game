        ...
        export function wizard_ang() {
         ...
         document.getElementById('canvas1').style.display = "block";
            drawWizard('canvas1', 'image2', '../img/wizard_ang/a', '.png' );
           
            positiv_monster -= 54;
            document.getElementById('positiv_monster').style.width = positiv_monster + "px";
           if (positiv_monster == 0) {
            draw('canvas6', 'image5', '../img//win/win', '.png' );
           ...
           export function monster_ang() {
            ...
            drawMonster('canvas5', 'image4', '../img/monster_ang/g', '.png' );
            
            positiv_me -= 54;
            
            document.getElementById('positiv_me').style.width = positiv_me + "px";
           if (positiv_me == 0) {
            draw('canvas6', 'image5', '../img/wizard_lose/lose', '.png' );
           
                document.getElementById("canvas").style.display = "none";
                document.getElementById("canvas6").style.marginLeft = "100px";
